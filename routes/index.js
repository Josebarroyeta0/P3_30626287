...
router.post('/register', function(req, res, next){
  ...
  productosModel
    ...
    .then(idClienteRegistrado=>{
      const mailOptions = { 
        from: 'theislaoftoys@gmail.com', 
        to: email, 
        subject: `Bienvenido a La isla de los juguetes!!!`, 
        text: `Hola!!\n 
        ¡Te damos la bienvenida a La isla de los juguetes!\n
        Tu registro ha sido completado de manera exitosa.\n\n
        Estamos emocionados de tenerte como parte de nuestra comunidad de amantes de los juguetes. En nuestra tienda encontrarás una amplia variedad de productos para todas las edades y gustos. ¡Esperamos que disfrutes explorando nuestro catálogo y encontrando el juguete perfecto para ti o tus seres queridos!\n\n 
        theislaoftoys ©2024. All rights reserved` 
      };
...
router.post('/payments', async (req, res, next)=>{
  ...
  try{
    const response = await axios.post ('https://fakepayment.onrender.com/payments', payments, {headers:{ Authorization:'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJuYW1lIjoiSm9obiBEb2UiLCJkYXRlIjoiMjAyNC0wMS0xMlQxNzoxMDoyMS44NTZaIiwiaWF0IjoxNzA1MDc5NDIxfQ.HuZ-adjpr0DoG5hbmM2UDZwBpZ7HcWlgWNvZEjxvWhk' }});
    const data = JSON.parse(JSON.stringify(response.data));
      ...
      .then(idFacturaRealizada =>{
        const mailOptions = { 
          ...
          text: `¡Hola, ${nombre}!\n\n 
          ¡Gracias por realizar tu compra en theislaoftoys Aqui la puedes ver al detalle:\n\n
...
//Filtrado de productos por edad
